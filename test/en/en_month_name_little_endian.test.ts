...
test("Test - Single expression", () => {
  ...
  testSingleCase(
    chrono,
    "The Deadline is Tuesday, 10 January",
    new Date(2012, 7, 10),
    (result) => {
      expect(result.index).toBe(16);
  ...
  testSingleCase(
    chrono,
    "The Deadline is Tue, 10 January",
    new Date(2012, 7, 10),
    (result) => {
      expect(result.index).toBe(16);
