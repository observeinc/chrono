...
test("Test - Single Expression", () => {
  testSingleCase(
    chrono,
    "She is getting married soon (July 2017).",
    (result) => {
  ...
  testSingleCase(
    chrono,
    "The Deadline is August 10 2555 BE",
    new Date(2012, 7, 10),
    (result) => {
      expect(result.index).toBe(16);
  ...
  testSingleCase(
    chrono,
    "The Deadline is August 10, 345 BC",
    new Date(2012, 7, 10),
    (result) => {
      expect(result.index).toBe(16);
  ...
  testSingleCase(
    chrono,
    "The Deadline is August 10, 8 AD",
    new Date(2012, 7, 10),
    (result) => {
      expect(result.index).toBe(16);
  ...
  testSingleCase(
    chrono,
    "The Deadline is Tuesday, January 10",
    new Date(2012, 7, 10),
    (result) => {
...
test("Test - Skip year-like on little-endian configuration", () => {
  const chronoMiddleEndian = new chrono.Chrono(
    chrono.en.configuration.createCasualConfiguration(false)
  );
  testSingleCase(
    chronoMiddleEndian,
    "Dec. 21",
  ...
  const chronoLittleEndian = new chrono.Chrono(
    chrono.en.configuration.createCasualConfiguration(true)
  );
  testSingleCase(
    chronoLittleEndian,
    "Dec. 21",
