...
test("Test - The normal within expression", () => {
  testSingleCase(
    chrono,
    "we have to make something in 5 days.",
    new Date(2012, 7, 10),
    (result) => {
  ...
  testSingleCase(
    chrono,
    "we have to make something in five days.",
    new Date(2012, 7, 10),
    (result) => {
      expect(result.index).toBe(26);
  ...
  testSingleCase(
    chrono,
    "we have to make something within 10 day",
    new Date(2012, 7, 10),
    (result) => {
      expect(result.index).toBe(26);
  ...
  testSingleCase(
    chrono,
    "In 5 minutes A car need to move",
    new Date(2012, 7, 10, 12, 14),
    (result) => {
      expect(result.index).toBe(0);
      expect(result.text).toBe("In 5 minutes");
  ...
  testSingleCase(
    chrono,
    "In 5 seconds A car need to move",
    new Date(2012, 7, 10, 12, 14),
    (result) => {
      expect(result.index).toBe(0);
...
test("Test - The within expression with multiple time units", function () {
  testSingleCase(
    chrono,
    "set a timer for 5 minutes 30 seconds",
    new Date(2012, 7, 10, 12, 14),
    (result) => {
  ...
  testSingleCase(
    chrono,
    "set a timer for 1 hour, 5 minutes, 30 seconds",
    new Date(2012, 7, 10, 12, 14),
    (result) => {
      expect(result.index).toBe(12);
